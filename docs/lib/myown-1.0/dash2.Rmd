...
```
```{r}
drake_election$loadTarget$plt_taiwanElection_partyColor()
save(plt_taiwanElection_partyColor, file="plt_taiwanElection_partyColor.Rdata")
```

```{r makecondition_pltElection}
